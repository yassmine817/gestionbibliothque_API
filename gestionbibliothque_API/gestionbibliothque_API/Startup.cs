...
namespace gestionbibliothque_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EmployerAdminContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("LibraryPortalDb")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "gestionbibliothque_API v1"));
            }
